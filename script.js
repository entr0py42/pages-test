// --- Plant Definitions ---
class Plant {
    constructor(name, growthTime, seedOutput, seedRange, harvestOutput, harvestRange, sellPrice, seasons = ["Spring", "Summer", "Autumn", "Winter"], seasonBonus = {}) {
      this.name = name;
  ...
  const plantList = [
    new Plant("Wheat", 0.2, 5, 1, 10, 2, 4),
...
let mouseButton = null;
  ...
  document.addEventListener('contextmenu', e => e.preventDefault()); // Disable default right-click
